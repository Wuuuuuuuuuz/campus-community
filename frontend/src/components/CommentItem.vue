...
<style scoped>
.comment-item { display: flex; margin-bottom: 12px; padding: 10px 0; border-bottom: 1px solid #f0f0f0; }
.comment-avatar { margin-right: 10px; flex-shrink: 0; }
.comment-body { flex: 1; }
.comment-header { font-size: 13px; margin-bottom: 4px; }
.comment-author { font-weight: 600; color: #333; }
.reply-to { color: #409eff; margin-left: 6px; }
.comment-time { color: #999; margin-left: 10px; }
.comment-content { line-height: 1.6; margin-bottom: 6px; }
